...
files2011data = FileUtils.loadListFromFile ('CMS_HIRun2011_HIHighPt_RECO_15Apr2013-v1_root_file_index_2.txt')
...
process.TFileService = cms.Service("TFileService",
                                   fileName=cms.string("HiForestAOD_DATAtest2011_part2.root"))
