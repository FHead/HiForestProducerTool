...
Analyzer::Analyzer(const ParameterSet &iConfig)
{
   ...
   if(FlagRECO)
   {
      ...
      Tree->Branch("PhotonEcalR03", PhotonEcalR03, "PhotonEcalR03[MaxNPhoton]/F");
      Tree->Branch("PhotonHcalR03", PhotonHcalR03, "PhotonHcalR03[MaxNPhoton]/F");
      Tree->Branch("PhotonTrackR03", PhotonTrackR03, "PhotonTrackR03[MaxNPhoton]/F");
      Tree->Branch("PhotonNTrackR03", PhotonNTrackR03, "PhotonNTrackR03[MaxNPhoton]/F");
      Tree->Branch("PhotonPFChargedIsolation", PhotonPFChargedIsolation, "PhotonPFChargedIsolation[MaxNPhoton]/F");
      Tree->Branch("PhotonPFNeutralIsolation", PhotonPFNeutralIsolation, "PhotonPFNeutralIsolation[MaxNPhoton]/F");
      Tree->Branch("PhotonPFPhotonIsolation", PhotonPFPhotonIsolation, "PhotonPFPhotonIsolation[MaxNPhoton]/F");
      Tree->Branch("PhotonE15", PhotonE15, "PhotonE15[MaxNPhoton]/F");
      Tree->Branch("PhotonE25", PhotonE25, "PhotonE25[MaxNPhoton]/F");
      Tree->Branch("PhotonE33", PhotonE33, "PhotonE33[MaxNPhoton]/F");
      Tree->Branch("PhotonE55", PhotonE55, "PhotonE55[MaxNPhoton]/F");
      Tree->Branch("PhotonSigmaEtaEta", PhotonSigmaEtaEta, "PhotonSigmaEtaEta[MaxNPhoton]/F");
      Tree->Branch("PhotonSigmaIEtaIEta", PhotonSigmaIEtaIEta, "PhotonSigmaIEtaIEta[MaxNPhoton]/F");
      Tree->Branch("PhotonR9", PhotonR9, "PhotonR9[MaxNPhoton]/F");
      Tree->Branch("PhotonR15", PhotonR15, "PhotonR15[MaxNPhoton]/F");
      Tree->Branch("PhotonR25", PhotonR25, "PhotonR25[MaxNPhoton]/F");
      Tree->Branch("PhotonHOverE", PhotonHOverE, "PhotonHOverE[MaxNPhoton]/F");
